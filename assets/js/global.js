        ...
        e.exports = function(e, t) {
            return function e(t, n, o) {
                if (n) {
                    var i = n.indexOf("."),
                        a = n,
                        s = null; - 1 !== i && (a = n.slice(0, i), s = n.slice(i + 1));
                    var c = t[a];
                    if (null != c)
...
document.addEventListener("DOMContentLoaded", function() {
    ! function(e) {
        ...
        if (s) {
            function u() {
                t.classList.remove("search-is-active"), n.style.display = "none", c.value = "", o.innerHTML = "", d.classList.add("is-hide"), a.classList.remove("is-hide"), window.scrollTo(0, 0)
            }
                            ...
                            if (r.innerHTML = "", o.innerHTML = "", this.value.length > 2 && (a.classList.add("is-hide"), d.classList.remove("is-hide")), this.value.length < 3 && (a.classList.remove("is-hide"), d.classList.add("is-hide")), !(this.value.length <= 2)) {
                                ...
                                r.innerHTML = n.length, n.map(function(e) {
                                    var t = new Date(e.published_at).toLocaleDateString(document.documentElement.lang, {
                                        ...
                                        z = document.createElement("h5"),
                                        s = document.createElement("a");
                                    n.textContent = n.innerHTML += t, s.textContent = e.title, s.setAttribute("href", e.url), o.appendChild(n), z.appendChild(s), o.appendChild(z)
                                })
                            }
                        })
