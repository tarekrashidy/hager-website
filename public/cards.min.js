! function() {
    const e = function(e) {
            ...
            let g = [{
                ...
                m = 1;
            const k = () => {
                    i.value = Math.floor(l.currentTime), u.textContent = p(i.value), t.style.setProperty("--seek-before-width", i.value / i.max * 100 + "%"), v = requestAnimationFrame(k)
                },
                y = e => {
            ...
            l.readyState > 0 ? (h(), L(), f()) : l.addEventListener("loadedmetadata", (() => {
                h(), L(), f()
            })), a.addEventListener("click", (() => {
                a.classList.add("kg-audio-hide"), o.classList.remove("kg-audio-hide"), l.play(), requestAnimationFrame(k)
            })), o.addEventListener("click", (() => {
                o.classList.add("kg-audio-hide"), a.classList.remove("kg-audio-hide"), l.pause(), cancelAnimationFrame(v)
            })), r.addEventListener("click", (() => {
                r.classList.add("kg-audio-hide"), s.classList.remove("kg-audio-hide"), l.muted = !1
            })), s.addEventListener("click", (() => {
                s.classList.add("kg-audio-hide"), r.classList.remove("kg-audio-hide"), l.muted = !0
            })), d.addEventListener("click", (() => {
                let e = g[(m + 1) % 5];
                m += 1, l.playbackRate = e.rate, d.textContent = e.label
            })), l.addEventListener("progress", f), i.addEventListener("input", (e => {
                y(e.target), u.textContent = p(i.value), l.paused || cancelAnimationFrame(v)
            })), i.addEventListener("change", (() => {
                l.currentTime = i.value, l.paused || requestAnimationFrame(k)
            })), n.addEventListener("input", (e => {
                const t = e.target.value;
                y(e.target), l.volume = t / 100
            }))
        },
...
function() {
    ...
    for (let o of e) {
        const i = o.querySelector("input"),
            d = o.querySelector(".kg-before-after-card-image-before"),
            r = o.querySelector(".kg-before-after-card-slider-button"),
            s = [...o.querySelectorAll("img")];

        function t() {
            d.setAttribute("style", `width: ${i.value}%`), r.setAttribute("style", `left: calc(${i.value}% - 18px`)
        }

        function a() {
            const e = getComputedStyle(s[0]).getPropertyValue("width");
            s[1].setAttribute("style", `width: ${e}`)
        }
...
function() {
    const e = function(e) {
            ...
            const h = () => {
                    d.value = Math.floor(c.currentTime), g.textContent = f(d.value), t.style.setProperty("--seek-before-width", d.value / d.max * 100 + "%"), y = requestAnimationFrame(h)
                },
                L = e => {
            ...
            c.readyState > 0 ? (b(), q(), S(), c.autoplay && (y = requestAnimationFrame(h), o.classList.add("kg-video-hide"), i.classList.remove("kg-video-hide")), c.muted && (n.classList.add("kg-video-hide"), s.classList.remove("kg-video-hide"))) : c.addEventListener("loadedmetadata", (() => {
                b(), q(), S(), c.autoplay && (y = requestAnimationFrame(h), o.classList.add("kg-video-hide"), i.classList.remove("kg-video-hide")), c.muted && (n.classList.add("kg-video-hide"), s.classList.remove("kg-video-hide"))
            })), e.onmouseover = () => {
            ...
            const E = () => {
                    v.classList.add("kg-video-hide-animated"), m.classList.add("kg-video-hide-animated"), o.classList.add("kg-video-hide"), i.classList.remove("kg-video-hide"), c.play(), y = requestAnimationFrame(h)
                },
                A = () => {
            ...
            v.addEventListener("click", (e => {
                ...
                e.stopPropagation(), s.classList.add("kg-video-hide"), n.classList.remove("kg-video-hide"), c.muted = !1
            })), n.addEventListener("click", (e => {
                e.stopPropagation(), n.classList.add("kg-video-hide"), s.classList.remove("kg-video-hide"), c.muted = !0
            })), r.addEventListener("click", (e => {
                e.stopPropagation();
                let t = k[(p + 1) % 5];
                p += 1, c.playbackRate = t.rate, r.textContent = t.label
            })), c.addEventListener("progress", S), d.addEventListener("input", (e => {
                e.stopPropagation(), L(e.target), g.textContent = f(d.value), c.paused || cancelAnimationFrame(y)
            })), d.addEventListener("change", (e => {
                e.stopPropagation(), c.currentTime = d.value, c.paused || requestAnimationFrame(h)
